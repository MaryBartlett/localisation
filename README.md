...
Further documentation can be found from the <a href="https://github.com/pages/MaryBartlett/localisation">jsdoc output</a> and also from <a href="https://github.com/pages/MaryBartlett/localisation/diagrams.html">sequence diagrams</a>
...
Then localisation needs to be configured by calling the createLocaliser function with a configuration object containing a supportedTerritories object, a supportedLanguages object, the territory as a string and optionally the language as a string. The supportedTerritories and supportedLanguages localeConfig that we use can be found in the <a href="https://github.com/MaryBartlett/localisation-configuration">localisation-configuration repo<a/>. It is assumed that this has been installed via NPM already in the following example.
